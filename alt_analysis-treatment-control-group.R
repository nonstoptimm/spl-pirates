...
summary(current_data$Sexnum[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
...
summary(current_data$`Year of Birth`[current_data$`Year of Birth` > 0 & (current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
...
summary(current_data$`Amount of Education Or Training in Years`[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
...
# (non)German people in treatment group
table(current_data$German[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
summary(current_data$German[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
...
summary(current_data$`Current Gross Labor Income in Euro`[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
...
summary(current_data$`Actual Work Time Per Week`[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 
    1)])
...
summary(current_data$working_exp_with_NA[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
...
summary(current_data$Minwagenona[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
...
summary(current_data$getminwage[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
}
...
summary(current_data$German[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
summary(current_data$`Current Gross Labor Income in Euro`[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
summary(current_data$`Actual Work Time Per Week`[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
summary(current_data$working_exp_with_NA[(current_data$Control_1 == 1 | current_data$Control_2 == 1 | current_data$Control_3 == 1)])
