...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **SOEPQ6_GraphicalAnalysisMinWage** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
```
![Log Employment of Binary Groups1 for Part Employment](plots/plot_treatment_t1part.png)
```r
...
```
![Log Employment of Binary Groups1 for Marginal Employment](plots/plot_treatment_ta1marginal.png)
```r
...
```
![Log Employment of Binary Groups2 for Full Employment](plots/plot_treatment_ta2full.png)
```r
...
```
![Log Employment of Binary Groups2 for Part Employment](plots/plot_treatment_ta2part.png)
```r
...
```
![Log Employment of Binary Groups2 for Marginal Employment](plots/plot_treatment_ta2marginal.png)
```r
