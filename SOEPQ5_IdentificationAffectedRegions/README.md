...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **SOEPQ5_IdentificationAffectedRegions** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
```
![Correlation of Bites](plots/plot_output_correlation_bites_yearly.png)
```r
...
```
![Correlation of Bites](plots/plot_output_correlation_bites_states.png)
```r
...
```
![Fraction Index over Years](plots/plot_density_aggr_fraction.png)
```r
plot_density_aggr_fraction = plot_density_aggregated(dbys, "Fraction")
# Save the plot_density_aggr_fraction
# ggsave('SOEPQ5_IdentificationAffectedRegions/plots/plot_aggregated_data_fraction.png', plot_density_aggr_fraction)
...
```
![Fraction Index over Year](plots/plot_aggregated_data_fraction.png)
```r
...
```
![Kaitz Index over Years](plots/plot_aggregated_data_kaitz.png)
```r
...
```
![Kaitz-Index: Density of States seperated by Years](plots/plot_density_aggr_kaitz.png)
```r
