...
# employment rate of full time employment in %
...
# employment rate of full log time employment in %
Employment.Status$Logg.Employment.Rate = Employment.Status$Log.Full.Employment/Employment.Status$Observation
