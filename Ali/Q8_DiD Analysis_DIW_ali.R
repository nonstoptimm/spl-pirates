...
DiD_DIW$DiD.estimator = DiD_DIW$year15.dummy * DiD_DIW$Kaitz
...
did_1.1.1 = plm(Log.Full.Employment ~ DiD.estimator, data = DiD_DIW, index=c("State.of.Residence", "Wave"), model = "within")
summary(did_1.1.1)
# Regression 1.1.2: Kaitz and Control: Population
did_1.1.2 = lm(Log.Full.Employment ~ (DiD.estimator) + Log.Population, data = DiD_DIW)
summary(did_1.1.2)
# Regression 1.1.3: Kaitz, Control: Population and Year2013
did_1.1.3 = lm(Log.Full.Employment ~ (DiD.estimator) + Log.Population + year13.dummy, data = DiD_DIW)
summary(did_1.1.3)
# Regression 1.1.4: Kaitz, Control: Population, Year2013, Year2012
did_1.1.4 = lm(Log.Full.Employment ~ (DiD.estimator) + Log.Population + year13.dummy + year12.dummy, data = DiD_DIW)
summary(did_1.1.4)
...
did_2.1.1 = lm(Log.Part.Employment ~ (DiD.estimator), data = DiD_DIW)
summary(did_2.1.1)
# Regression 2.1.2: Kaitz and Control: Population
did_2.1.2 = lm(Log.Part.Employment ~ (DiD.estimator) + Log.Population, data = DiD_DIW)
summary(did_2.1.2)
# Regression 2.1.3: Kaitz, Control: Population and Year2013
did_2.1.3 = lm(Log.Part.Employment ~ (DiD.estimator) + Log.Population + year13.dummy, data = DiD_DIW)
summary(did_2.1.3)
# Regression 2.1.4: Kaitz, Control: Population, Year2013, Year2012
did_2.1.4 = lm(Log.Part.Employment ~ (DiD.estimator) + Log.Population + year13.dummy + year12.dummy, data = DiD_DIW)
summary(did_2.1.4)
...
did_3.1.1 = lm(Log.Marginal.Employment ~ (DiD.estimator), data = DiD_DIW)
summary(did_3.1.1)
# Regression 3.1.2: Kaitz and Control: Population
did_3.1.2 = lm(Log.Marginal.Employment ~ (DiD.estimator) + Log.Population, data = DiD_DIW)
summary(did_3.1.2)
# Regression 3.1.3: Kaitz, Control: Population and Year2013
did_3.1.3 = lm(Log.Marginal.Employment ~ (DiD.estimator) + Log.Population + year13.dummy, data = DiD_DIW)
summary(did_3.1.3)
# Regression 3.1.4: Kaitz, Control: Population, Year2013, Year2012
did_3.1.4 = lm(Log.Marginal.Employment ~ (DiD.estimator) + Log.Population + year13.dummy + year12.dummy, data = DiD_DIW)
summary(did_3.1.4)
