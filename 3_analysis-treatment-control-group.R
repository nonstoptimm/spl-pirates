...
summary(merged2015$`Amount of Education Or Training in Years`[(merged2015$Control_1 == 1 | merged2015$Control_2 == 1 | merged2015$Control_3 == 1)])
...
summary(merged2015$`Current Gross Labor Income in Euro`[(merged2015$Control_1 == 1 | merged2015$Control_2 == 1 | merged2015$Control_3 == 1)])
...
summary(merged2015$`Actual Work Time Per Week`[(merged2015$Control_1 == 1 | merged2015$Control_2 == 1 | merged2015$Control_3 == 1)])
...
merged2015$working_exp_with_NA[merged2015$`Working Experience Full-Time Employment` >= 0] <- merged2015$`Working Experience Full-Time Employment`[merged2015$`Working Experience Full-Time Employment`>= 0]
...
summary(merged2015$`Year of Birth`[merged2015$`Year of Birth` > 0 & (merged2015$Control_1 == 1 | merged2015$Control_2 == 1 | merged2015$Control_3 == 1)])
...
#results:
  ...
  summary(merged2015$`Year of Birth`[merged2015$`Year of Birth` > 0 & merged2015$Treatment == 1])
    ...
    #charcateristics of the treatment group:
      #Sex
        # 58,93 % women
      #Nationality
        # 80,7 % German
      #Education or Traning in years
        # Median 11.50 years, Mean 11.65 years 
      #Current gross labor income in €
        # Median 741.0 €, Mean 980.6 €
      #Actual work time per week in hours
        # Median 38.00 h, Mean 32.84 €
      #Working expirience in years
        # Median 4.000 years, Mean 9.215 years
      #Minimum wage in €
        # Median  8.500 €, Mean 8.508 €
      #Collective wage agreement min wage
        # 28.77 %
      #Year of birth
        #Median, Mean 1977
  ...
  summary(merged2015$`Year of Birth`[merged2015$`Year of Birth` > 0 & (merged2015$Control_1 == 1 | merged2015$Control_2 == 1 | merged2015$Control_3 == 1)])
    ...
    #charcateristics of the control group:
      #Sex
        # 66,25% women
      #Nationality
        # 76.81% German
      #Education or Traning in years
        # Median 11.50 years, Mean 11.54 years
      #Current gross labor income in €
        # Median 1300 €, Mean 1177 €
      #Actual work time per week in hours
        # Median 35.00 h, Mean 32.06 h 
      #Working expirience in years
        # Median 7.90 years, Mean 11.48 years
      #Minimum wage in €
        # Median  8.500 €, Mean 8.828 €
      #Collective wage agreement min wage
        # 20.34 %
      #Year of birth
        #Median 1972, Mean 1973
